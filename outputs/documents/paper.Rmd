...
The application of n-gram is versatile. N-gram is widely applied in text prediction, spelling-correction, machine translation. We use n-gram to [add how we use n-gram once the functions in the app are in place]
...
These parameters refer to the weights of the connections that enable the neural network to learn **(Keli add citation)**. GPT-3 can learn NLP tasks with few examples and without a task-specific dataset **(Keli add citation)**.
