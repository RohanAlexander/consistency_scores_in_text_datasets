...
The above examples using GPT-2 were task-agnostic but they were in need of fine-tuning.
These parameters refer to the weights of the connections that enable the neural network to learn **(Keli add citation)**. GPT-3 can learn NLP tasks with few examples and without any task-specific dataset **(Keli add citation)**.


GPT-3 is pre-trained, and takes a sample of text as an input **(Ke-Li add more detail about what it needs and what it outputs and how it works).**. 
...
have been shown to implicitly capture useful semantic and syntactic properties of text solely by
arXiv:1906.08646v1 [cs.CL] 19 Jun 2019
