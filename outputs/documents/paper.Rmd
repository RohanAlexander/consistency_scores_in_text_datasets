...
**(Keli adds implementation of BERT in R)**
BERT implementation in R is also possible through Keras. Zhao HG (**Replace by citation**) created a python module called Keras-bert and the module can be called by R through reticulate package, which enables interoperability between Python and R. 
