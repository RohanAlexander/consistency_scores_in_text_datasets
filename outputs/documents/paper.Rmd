...
The model that we use to forecast is GPT-3 by OpenAI. OpenAI is... **(Ke-Li to add a two sentence summary in boring academic language)**. GPT-3 is... **(Ke-Li to add a three sentence summary in boring academic language)**.
